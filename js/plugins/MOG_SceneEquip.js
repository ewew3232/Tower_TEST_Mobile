...
Scene_Equip.prototype.create = function () {
	...
	this._commandWindow.width = 660;//追加
	...
	this._slotWindow.width = 620;//追加
	//this._slotWindow.height = 320;//追加
	this._itemWindow.x = Moghunter.scEquip_ItemWindowX;
	this._itemWindow.y = Moghunter.scEquip_ItemWindowY;
	this._itemWindow.width = 620;//this._slotWindow.width
	this._itemWindow.height = 320;
...
Window_EquipStatus.prototype.createFaceSprite = function () {
	...
	this._faceSprite.x = 180;
	this._faceSprite.y = -20;
...
Window_EquipStatus.prototype.drawParamName = function (x, y, paramId) {
 this.drawText(TextManager.param(paramId), x, y, 120);
  this.changeTextColor(this.textColor(1));//追加
};
