...
/*:ja
 * @plugindesc (v1.0) 要MOG_SceneMenuとMOG_SceneEquip。ステータスシーンを装飾します。
 * @author Moghunter
 *
 * @param Bust X-Axis
 * @text アクター画像のX軸位置
...
Moghunter.scStatus_ShoesX = Number(Moghunter.parameters['Shoes X-Axis'] || 400);//追加足の位置
Moghunter.scStatus_ShoesY = Number(Moghunter.parameters['Shoes Y-Axis'] || 450);//追加足の位置
...
Window_Status.prototype.refresh = function () {
	...
	if (this._actor) {
		...
		this.drawItemName(this._actor.equips()[5], Moghunter.scStatus_ShoesX, Moghunter.scStatus_ShoesY);//追加
